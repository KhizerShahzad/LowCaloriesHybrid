...
class CalorieItem extends StatelessWidget {
  CalorieItem({super.key, required this.itemIndex, required this.notifier});
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                width: 2,
                color: notifier.caloriesList[itemIndex].isSelected
          ...
          child: Center(
            child: DefaultTextStyle(
              ...
              child: Text(notifier.caloriesList[itemIndex].listTitle),
            ),
          ),
        ),
      ) ,
